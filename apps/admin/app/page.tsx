...
export default function AdminPortalPage() {
  ...
  // Use a ref to track activity without triggering React re-renders on every mouse move
  ...
  <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
      ...
      <header className="shrink-0 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-3 sm:px-8 py-2.5 sm:py-3 flex items-center justify-between">
      ...
      {/* Main Container */}
      <main className="flex-1 overflow-y-auto w-full px-3 sm:px-6 lg:px-8 py-4 sm:py-8 pb-24 md:pb-8 space-y-4 sm:space-y-6">
        ...
        <div className="hidden items-center gap-1.5 overflow-x-auto no-scrollbar bg-slate-900/80 p-1.5 rounded-2xl border border-slate-800">
          {[
            {
              id: 'seller_approvals',
              ...
              <form onSubmit={handlePostLivestock} className="space-y-5 w-full max-w-full min-w-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-5 w-full max-w-full min-w-0">
                  ...
                  <div className="md:col-span-8 space-y-4 w-full max-w-full min-w-0">
                    ...
                    {postGender === 'FEMALE' && (
                      <div className="p-3 bg-slate-950/80 border border-emerald-500/30 rounded-2xl space-y-2.5">
                        <div className="flex items-center justify-between border-b border-slate-800 pb-1.5">
                          <span className="text-xs font-bold text-emerald-400 flex items-center gap-1.5">
                            <span>🥛</span>
                            <span>Dairy Cow & Maternal Profile (የማልዳ / የወተት ላም)</span>
                          </span>
                          <span className="text-[10px] text-emerald-400/80 bg-emerald-950/60 px-1.5 py-0.5 rounded border border-emerald-800/50">
                            Dairy Specs
                          </span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-slate-900 border border-slate-700 rounded-xl py-2 px-3 text-xs text-white outline-none focus:border-emerald-500"
                            />
                          </div>
      ...
      <nav aria-label="Mobile Navigation" className="hidden fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 border-t border-slate-800 backdrop-blur-xl px-1.5 py-1.5 flex items-center justify-around shadow-2xl">
        {[
          {
            id: 'seller_approvals',
            label: 'Sellers',
